...
class ResNet_plus2(nn.Module):
    def __init__(self, block, layers, used_layers, online=False):
        ...
        self.feature_size = 128 * block.expansion    # 128*4
        self.used_layers = used_layers
        self.layer3_use = True if 3 in used_layers else False      # true
        self.layer4_use = True if 4 in used_layers else False    # false
