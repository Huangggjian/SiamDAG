...
def parse_args():
    ...
    parser.add_argument('--arch', default='DAG', type=str, help='backbone architecture')
    parser.add_argument('--resume', default='snapshot/DAGV19on.pth', type=str, help='pretrained model')
